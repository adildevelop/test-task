...
--
-- Name: advertisement; Type: DATABASE; Schema: -; Owner: db_user
--

CREATE DATABASE advertisement WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'ru_RU.UTF-8' LC_CTYPE = 'ru_RU.UTF-8';


ALTER DATABASE advertisement OWNER TO db_user;
